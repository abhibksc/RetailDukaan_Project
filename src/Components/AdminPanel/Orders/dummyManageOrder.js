...
const ManageOrder = () => {
  ...
  const [isOrderDeliveryModalOpen, setIsOrderDeliveryModalOpen] =
    ...
    const [isMakeDelvieryBoyFreeModalOpen, setIsMakeDeliveryBoyFreeModalOpen] = useState(false);
...
Generate Cancel Request
  ...
  onChange={(e)=>handleOrderStatusChangeByMerchant(e.target.value,item.id )}
          ...
          <option key={item.id} value="received">received</option>
          <option key={item.id} value="processed">processed</option>
          <option key={item.id} value="shipped">shipped</option>
          <option key={item.id} value="cancelled">cancelled</option>
          <option key={item.id} value="completed">completed</option>
                    </select>
                        </td>
