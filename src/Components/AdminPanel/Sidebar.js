...
const Sidebar = ({ onLinkClick }) => {
  ...
  const sidebarLinks = [
    ...
    // {
    //   to: `/admin/${Merchanttoken}/homemangement`,
...
,
    ...
    // { to: `/admin/${Merchanttoken}/items`, label: "Items", icon: <FaTags /> },
    // { to: `/admin/${Merchanttoken}/stocks`, label: "Stocks", icon: <FaTags /> },
    {
    ...
    // { to: `/admin/${Merchanttoken}/coupons`, label: "Coupons", icon: <FaTags /> },
    ...
    {
      to: `/admin/${Merchanttoken}/manageusers`,
      label: "Manage Users",
      icon: <FaUserCog />,
    },
    {
    ...
    // { to: "/admin/adminprofile", label: "Profile", icon: <FaBox /> },
    // { to: `/admin/${Merchanttoken}/rating&reviews`, label: "Ratings & Reviews", icon: <FaBox /> }
  ];
  ...
  return (
    <div className="xl:fixed xl:top-0 xl:left-0 xl:w-72 xl:h-screen bg-gray-800 text-white  flex flex-col justify-between overflow-y-scroll scrollbar-hide">
      <div>
        <div className="flex  items-center mb-5 border-b p-4 cursor-pointer bg-green-500 " onClick={handleprofileClick}>
          <img
            src={logo}
            alt="logo"
            className="w-9 h-7 mr-3 ml-3"
          />
