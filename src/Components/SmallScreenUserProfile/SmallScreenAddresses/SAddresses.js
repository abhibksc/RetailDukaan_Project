...
import LocateOnMap from "../../UserProfile/Addresses/LocateOnMap";
import { getAllAddress } from "../../CrudOperations/GetOperation";
import ValidationModal from "../../UserProfile/Addresses/ValidationModal";
...
setLoading(false);
  ...
  {/* <div className="just minus that height from the h-screen. border border-b-2 border-blue-500 overflow-y-auto "> */}
      <div className="flex gap-4  justify-center  mt-20 overflow-y-auto">

{mapModal && <LocateOnMap handleLocateOnMap = {handleLocateOnMap} handleLocateOnMapDetails = {handleLocateOnMapDetails}/>}

 <div className="bg-white flex flex-col gap-4 border pt-4 w-full p-2 ">


   
   <h1 className="font-bold text-xl font-roboto px-2">Manage Addresses</h1>

   {hide !== "new address" && (
     <h1
       className="font-roboto text-sm text-blue-600 font-bold cursor-pointer"
       onClick={() => {
   ...
   {hide === "new address" && (
     <form
       className="bg-blue-100 border p-3  flex flex-col gap-5 w-screen "
       onSubmit={handleSubmit}
     >
       <h1
         className="text-blue-600 text-sm font-bold font-roboto cursor-pointer"
         onClick={() => setHide("")}
       >
         ➕ ADD A NEW ADDRESS
       </h1>
       ...
       <span
         ...
         className="border cursor-pointer bg-blue-400 p-2 flex gap-2 px-3 rounded-sm shadow-sm shadow-blue-300"
       >
       ...
       <span
         ...
         className="border  cursor-pointer bg-green-400 p-2 flex gap-2 px-3 rounded-sm shadow-sm shadow-blue-300"
       >
         <FaLocationCrosshairs className="mt-1" />
         <span>Map</span>
       </span>
