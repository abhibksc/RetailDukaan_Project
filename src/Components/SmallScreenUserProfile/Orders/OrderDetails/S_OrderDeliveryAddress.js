...
const S_OrderDeliveryAddress = ({ delivery_Addresss_data }) => {
  ...
  return (
    <div className="bg-white px-5 flex justify-between border-b-[1px] py-3">
      <div className="   font-extralight ">
        <h2 className="text-[15px] font-bold mb-4">Shipping Details</h2>

        <div className="mb-6 flex flex-col gap-3">
          <p className="font-semibold text-[14px] text-gray-800">{name}</p>
          <p className=" text-[13px] text-gray-700">
            {full_addresss}, {landmark}, {locality}, {city}, {state} -{" "}
            {pin_code}
          </p>
          <p className=" text-[13px] text-gray-700">
...
export default S_OrderDeliveryAddress;
